            ...
            <div class="container centered">
                <div class="thumbnail col-md-12 " style="padding-left: 10px; margin-bottom: 0px;" >
                    ...
                    <div class="col-md-3" style="padding-left:0px;margin-top: 10px ">
                        <a class="btn btn-primary" style="width: 280px;height: 100px" href="transparenciaxCategoria.jsp?tag=asamblea universitaria"><i class="fa fa-institution fa-5x" ></i></a>
                        <div class="">ASAMBLEA UNIVERSITARIA</div>
                    </div>
                    <div class="col-md-3" style="padding-left:0px;margin-top: 10px ">
                        <a class="btn btn-primary" style="width: 280px;height: 100px" href="transparenciaxCategoria.jsp?tag=consejo universitario"><i class="fa fa-users fa-5x" ></i></a>
                        <div class="">CONSEJO UNIVERSITARIO</div>
                    </div>
                    <div class="col-md-3" style="padding-left:0px;margin-top: 10px ">
                        <a class="btn btn-primary" style="width: 280px;height: 100px" href="transparenciaxCategoria.jsp?tag=organización"><i class="fa fa-book fa-5x" ></i></a>
                        <div class="">ORGANIZACIÓN</div>
                    </div>
                    <div class="col-md-3" style="padding-left:0px;margin-top: 10px ">
                        <a class="btn btn-primary" style="width: 280px;height: 100px" href="transparenciaxCategoria.jsp?tag=información institucional"><i class="fa fa-file-text fa-5x" ></i></a>
