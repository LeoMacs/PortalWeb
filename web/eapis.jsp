    ...
    <body>
        ...
        <header>
            <div class="w3-bar w3-white w3-large">
                ...
                <!--*******************-->
                <form  style ="padding: 0px;" class="w3-bar-item w3-button w3-right  thumbnail-efect" method="post" action="resultBusqPubli.jsp">
                    ...
                    <button type="submit" id="search" class="btn-primary" style="text-align:center;width: 100px"><a href="" style="color:#FFFFFF;"><i class="fa fa-search">&nbsp;Buscar</i></a></button>
                </form>
            </div>
