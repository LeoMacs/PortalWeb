...
public class modificarPublicacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idProducto = Integer.parseInt(request.getParameter("idpublicacion"));
        String oficina = request.getParameter("oficina");
       String titulo = request.getParameter("titulo");
       String detalle= request.getParameter("detalle");
       
       publicacion p = new publicacion(idProducto,oficina,titulo, detalle, "");
        controladorPublicacion cp= new controladorPublicacion();
       if(cp.updateProducto(p)){
           response.getWriter().println("Producto modificado");
       }else{
           response.getWriter().println("Error al  modificar");
       }
    }
